...
public class A_MinhitPlayer : Achievement {

     public A_MinhitPlayer()
        : base()
    {
        Name = "minhitplayer";
        Description = "Complete ALL levels of ALL packs(except level-20 of PACK-4) in Minimum Hit Mode, Good Luck!!";
